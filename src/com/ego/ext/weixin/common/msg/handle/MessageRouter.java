...
/*
     public MessageRouter(WxMpService wxMpService) {
     this.wxMpService = wxMpService;
     this.executorService = Executors.newFixedThreadPool(DEFAULT_THREAD_POOL_SIZE);
     }

     public MessageRouter(WxMpService wxMpService, int threadPoolSize) {
     this.wxMpService = wxMpService;
    ...
    public static class Rule {
        ...
        protected Rule(MessageRouter routerBuilder, WxMpService wxMpService) {
