...
public class UtilBean {
     ...
     * &nbsp; &nbsp; 2) {@link String} 类型：先执行自动类型转换再对属性或成员变量赋值<br>
     * &nbsp; &nbsp; 3) {@link String}[] 类型：先执行自动类型转换再对属性或成员变量赋值<br>
     * @param keyMap	: properties.key / Bean 属性或成员变量名映射，当 properties 的 key
     * 与属性或成员变量名不对应时， 用 keyMap 把它们关联起来
     * @return	生成的 Bean 实例
     */
     ...
     * &nbsp; &nbsp; 2) {@link String} 类型：先执行自动类型转换再对成员变量值<br>
     * &nbsp; &nbsp; 3) {@link String}[] 类型：先执行自动类型转换再对成员变量值<br>
     * @param keyMap	: values.key / Bean 成员变量名映射，当 values 的 key 与成员变量名不对应时， 用
     * keyMap 把它们关联起来
     * @return	生成的 Bean 实例
     */
     ...
     * &nbsp; &nbsp; 2) {@link String} 类型：先执行自动类型转换再成员变量赋值<br>
     * &nbsp; &nbsp; 3) {@link String}[] 类型：先执行自动类型转换再成员变量赋值<br>
     * @param keyMap	: properties.key / Bean 成员变量名映射，当 properties 的 key
     * 与成员变量名不对应时， 用 keyMap 把它们关联起来
     */
     ...
     * @param clazz	: 目标类型<br>
     * @param genericType	: 目标类型的元素类型 (只当目标类型是 {@link List} 或 {@link Set}
     * 等集合类型时才需要)<br>
     */
